...
// create knex instance to connect to db
// clear any data to ensure clean tables.
// disconnect from the database so that the tests don't "hang".
describe('Articles Endpoints', function() {
  ...
  // insert some rows into the blogful_articles table before the test
